	...
	<nav class="navbar navbar-expand-lg #ffffff white">
		...
		<div class="collapse navbar-collapse" id="basicExampleNav">
			...
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a class="nav-link h3 my-1" href="${pageContext.request.contextPath}/moimmap.do">
						<font size='2' color='black'><strong>한국브레들린지도</strong></font>
					</a></li>
				...
				<c:if test="${sessionScope.isAdmin eq 'y'}">
					<li class="nav-item"><a class="nav-link h3 my-1" href="${pageContext.request.contextPath}/userList.do">
						<font size='2' color='black'><strong>모임주소록</strong></font>
					</a></li>
