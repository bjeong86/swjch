...
<body class="grey lighten-3">
	...
	<div class="container-fluid">
		...
		<!--Card-->
		<div class="card #fafafa grey lighten-5  mb-2">
										...
										<div class="avatar mx-auto mb-1">
											...
											<div class="row">
												...
												<div class="col-lg-4 col-md-12">
													<img src="${pageContext.request.contextPath}/resources/img/swj/sub_1.jpg" class="rounded" height='300px' alt="First sample avatar image">
													<br><br>
												</div>
												<div class="col-lg-4 col-md-12">
													<img src="${pageContext.request.contextPath}/resources/img/swj/sub_2.jpg" class="rounded" height='300px' alt="First sample avatar image">
													<br><br>
												</div>
												<div class="col-lg-4 col-md-12">
													<img src="${pageContext.request.contextPath}/resources/img/swj/sub_3.jpg" class="rounded" height='300px' alt="First sample avatar image">
													<br><br>
												</div>
											</div>
										</div>
									...
									<div class="testimonial">
										...
										<div class="avatar mx-auto mb-1">
											...
											<div class="row">
												<!-- Grid column -->
												<div class="col-lg-4 col-md-12">
													<img src="${pageContext.request.contextPath}/resources/img/swj/sub_4.jpg" class="rounded" height='300px' alt="First sample avatar image">
													<br><br>
												</div>
												<div class="col-lg-4 col-md-12">
													<img src="${pageContext.request.contextPath}/resources/img/swj/sub_5.jpg" class="rounded" height='300px' alt="First sample avatar image">
													<br><br>
												</div>
												<div class="col-lg-4 col-md-12">
													<img src="${pageContext.request.contextPath}/resources/img/swj/sub_6.jpg" class="rounded" height='300px' alt="First sample avatar image">
													<br><br>
												</div>
											</div>
										</div>
									...
									<div class="testimonial">
										...
										<div class="avatar mx-auto mb-1">
											...
											<div class="row">
												<!-- Grid column -->
												<div class="col-lg-4 col-md-12">
													<img src="${pageContext.request.contextPath}/resources/img/swj/sub_7.jpg" class="rounded" height='300px' alt="First sample avatar image">
													<br><br>
												</div>
												<div class="col-lg-4 col-md-12">
													<img src="${pageContext.request.contextPath}/resources/img/swj/sub_8.jpg" class="rounded" height='300px' alt="First sample avatar image">
													<br><br>
												</div>
												<div class="col-lg-4 col-md-12">
													<img src="${pageContext.request.contextPath}/resources/img/swj/sub_9.jpg" class="rounded" height='300px' alt="First sample avatar image">
													<br><br>
												</div>
											</div>
										</div>
									...
									<div class="testimonial">
										...
										<div class="avatar mx-auto mb-1">
											...
											<div class="row">
												<!-- Grid column -->
												<div class="col-lg-4 col-md-12">
													<img src="${pageContext.request.contextPath}/resources/img/swj/sub_10.jpg" class="rounded" height='300px' alt="First sample avatar image">
													<br><br>
												</div>
												<div class="col-lg-4 col-md-12">
													<img src="${pageContext.request.contextPath}/resources/img/swj/sub_11.jpg" class="rounded" height='300px' alt="First sample avatar image">
													<br><br>
												</div>
												<div class="col-lg-4 col-md-12">
													<img src="${pageContext.request.contextPath}/resources/img/swj/sub_12.jpg" class="rounded" height='300px' alt="First sample avatar image">
													<br><br>
												</div>
											</div>
										</div>
									...
									<div class="testimonial">
										...
										<div class="avatar mx-auto mb-1">
											...
											<div class="row">
												<!-- Grid column -->
												<div class="col-lg-4 col-md-12">
													<img src="${pageContext.request.contextPath}/resources/img/swj/sub_13.jpg" class="rounded" height='300px' alt="First sample avatar image">
													<br><br>
												</div>
												<div class="col-lg-4 col-md-12">
													<img src="${pageContext.request.contextPath}/resources/img/swj/sub_14.jpg" class="rounded" height='300px' alt="First sample avatar image">
													<br><br>
												</div>
												<div class="col-lg-4 col-md-12">
													<img src="${pageContext.request.contextPath}/resources/img/swj/sub_15.jpg" class="rounded" height='300px' alt="First sample avatar image">
													<br><br>
												</div>
											</div>
										</div>
				...
				<div class="card #cfd8dc blue-grey lighten-4">
					...
					<div class="card-header" onclick="javascript:showNews();">
						...
						<h2 class="h2-responsive font-weight-bold text-center my-1">
							<font size='3' color='black'><b>모임뉴스</b></font>
						</h2>
					</div>
					<div id="news" class="card-body #fafafa grey lighten-5">
						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-3 mb-lg-0 mb-3">
								...
								<button class="list-group-item list-group-item-action waves-effect btn btn-sm #eceff1 blue-grey lighten-5" type="button" aria-haspopup="true" aria-expanded="false">
									<center>
										<i class="fas fa-book-open fa-2x"></i>&nbsp;&nbsp;&nbsp;<font size='3' color='black'>집회소식</font>
									</center>
								</button>
							...
							<div class="col-lg-3 col-md-3 mb-md-0 mb-3">
								...
								<button class="list-group-item list-group-item-action waves-effect btn btn-sm #eceff1 blue-grey lighten-5" type="button" aria-haspopup="true" aria-expanded="false">
									<center>
										<i class="fas fa-bible fa-2x"></i>&nbsp;&nbsp;&nbsp;<font size='3' color='black'>지역교회/선교</font>
									</center>
								</button>
							...
							<div class="col-lg-3 col-md-3 mb-0 mb-3">
								...
								<button class="list-group-item list-group-item-action waves-effect btn btn-sm #eceff1 blue-grey lighten-5" type="button" aria-haspopup="true" aria-expanded="false">
									<center>
										<i class="fas fa-archway fa-2x"></i>&nbsp;&nbsp;&nbsp;<font size='3' color='black'>교육/훈련</font>
									</center>
								</button>
							...
							<div class="col-lg-3 col-md-3 mb-0 mb-3">
								...
								<button class="list-group-item list-group-item-action waves-effect btn btn-sm #eceff1 blue-grey lighten-5" type="button" aria-haspopup="true" aria-expanded="false">
									<center>
										<i class="fas fa-bullhorn fa-2x"></i>&nbsp;&nbsp;&nbsp;<font size='3' color='black'>경조사</font>
									</center>
								</button>
		...
		<div class="col-md-6 mb-2">
			...
			<div class="card #cfd8dc blue-grey lighten-4">
				...
				<div class="card-header" onclick="javascript:showRoute();">
					<!-- Section heading -->
					<h2 class="h2-responsive font-weight-bold text-center my-1">
						<font size='3' color='black'><b>찾아오시는길</b></font>
					</h2>
					<!-- Section description -->
				</div>
		...
		<div class="col-md-12 mb-2">
			...
			<div class="card #cfd8dc blue-grey lighten-4">
				...
				<div class="card-header" onclick="javascript:showMovie();">
					<!-- Section heading -->
					<h2 class="h2-responsive font-weight-bold text-center my-1">
						<font size='3' color='black'><b>말씀영상</b></font>
					</h2>
				</div>
